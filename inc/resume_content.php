<div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">[%tr%]my name[%/tr%]</span>
            <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2 thumbnail"
                                                 src="/img/profile-thumbnail.png" alt="..."/></span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">[%tr%]About[%/tr%]</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger"
                                        href="#experience">[%tr%]Experience[%/tr%]</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#education">[%tr%]Education[%/tr%]</a>
                </li>
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                <h1 class="mb-0">
                    [%tr%]my first name[%/tr%]
                    <span class="text-primary">[%tr%]my last name[%/tr%]</span>
                </h1>
                <div class="subheading mb-5">
                    [%tr%]contact info[%/tr%]
                    <a href="mailto:name@email.com">[%tr%]contact email[%/tr%]</a>
                </div>
                <p class="lead mb-5">[%tr%]about text[%/tr%]</p>
                <!--
        ...
        <section class="resume-section" id="experience">
            <div class="resume-section-content">
                <h2 class="mb-5">[%tr%]Experience[%/tr%]</h2>
                <!--
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">[%tr%]HiWi Job[%/tr%]</h3>
                        <div class="subheading mb-3">[%tr%]HiWi Workplace[%/tr%]</div>
                        <p>[%tr%]HiWi Description[%/tr%]</p>
                    </div>
                    <div class="flex-shrink-0"><span class="text-primary">[%tr%]HiWi Time[%/tr%]</span></div>
                </div>
            </div>
        </section>
        <hr class="m-0"/>
        ...
        <section class="resume-section" id="education">
            <div class="resume-section-content">
                <h2 class="mb-5">[%tr%]Education[%/tr%]</h2>
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">[%tr%]uni name[%/tr%]</h3>
                        <div class="subheading mb-3">[%tr%]uni bachelor[%/tr%]</div>
                        <div>[%tr%]uni bachelor title[%/tr%]</div>
                        <p>[%tr%]uni degree[%/tr%]</p>
                    </div>
                    <div class="flex-shrink-0"><span class="text-primary">[%tr%]abi time[%/tr%]</span></div>
                </div>
                <div class="d-flex flex-column flex-md-row justify-content-between">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">[%tr%]abi name[%/tr%]</h3>
                        <div class="subheading mb-3">[%tr%]abi title[%/tr%]</div>
                        <p>[%tr%]abi degree[%/tr%]</p>
                    </div>
                    <div class="flex-shrink-0"><span class="text-primary">[%tr%]abi time[%/tr%]</span></div>
                </div>
            </div>
        ...
        <section class="resume-section" id="skills">
            <div class="resume-section-content">
                <h2 class="mb-5">[%tr%]Skills[%/tr%]</h2>
                <div class="subheading mb-3">[%tr%]Programming Languages[%/tr%] & [%tr%]Tools[%/tr%]</div>
                <ul class="list-inline dev-icons">
                    ...
                    <!--
                    <li class="list-inline-item"><i class="fab fa-terminal"></i></li>
                    -->
                </ul>
                <!--
        ...
        <section class="resume-section" id="interests">
            <div class="resume-section-content">
                <h2 class="mb-5">[%tr%]Interests[%/tr%]</h2>
